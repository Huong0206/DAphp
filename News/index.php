                ...
                <div class="row">
                    <div class="col-md-6 tn-left">
                        <div class="row tn-slider">
                            <?php 
                                $str = "select * from tin where AnHien=1 and lang='vi' order by idTin desc limit 0,4";
                    ...
                    <div class="col-md-6 tn-right">
                        <div class="row">
                            <?php $str = "select * from tin where AnHien=1 and lang='vi' order by idTin desc limit 5,4";
                                    $result = mysqli_query ($conn,$str);
                                    while ($row = mysqli_fetch_assoc($result)){
                            ?>                    
                            <div class="col-md-6">
        ...
        <div class="cat-news">
            <div class="container">
                <div class="row">
                    ...
                    ?>                    
                    <div class="col-md-6">
                        <h2><?php echo $row_theloai['TenTL']; ?></h2>
